  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Streamline Your Workforce with HR Management System: Manage Employee Data, Payrolls, Time Tracking, Vacations, and Performance Evaluations in One Central Place."
        />
      </Head>
      <HomeLayout>
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Streamline Your Workforce with HR Management System: Manage Employee Data, Payrolls, Time Tracking, Vacations, and Performance Evaluations in One Central Place.`}
            </Text>
            <Box
